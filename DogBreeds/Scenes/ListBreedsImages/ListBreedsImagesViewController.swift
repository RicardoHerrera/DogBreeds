//
//  ListBreedsImagesViewController.swift
//  DogBreeds
//
...
class ListBreedsImagesViewController: UITableViewController, ListBreedsImagesDisplayLogic
{
    ...
    private func setup()
    {
        ...
        let interactor = ListBreedsImagesInteractor()
        let presenter = ListBreedsImagesPresenter()
        let router = ListBreedsImagesRouter()
    ...
    {//breedDefault
        let displayedBreed = imagesURLs[indexPath.row]
        guard let cell = tableView.dequeueReusableCell(withIdentifier: BreedImageTableViewCell.ReuseIdentifier) as? BreedImageTableViewCell else {
